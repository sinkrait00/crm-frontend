...
const Loader = ()=>{
    return(
        <svg xmlns="http://www.w3.org/2000/svg"  style={{
            margin:"auto",display:"block"}} width="75px" height="75px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
            <rect fill="#da6651" x="15" y="15" width="30" height="30" rx="3" ry="3">
            ...
            </rect><rect fill="#f3ac55" x="15" y="15" width="30" height="30" rx="3" ry="3">
        ...
        </rect><rect fill="#32c581" x="15" y="15" width="30" height="30" rx="3" ry="3">
